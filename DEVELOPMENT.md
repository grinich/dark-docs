...
- This repository, Chrome 120 or later, Node.js 22 or later, and Python 3.
...
5. Attach the ZIP to a GitHub release and upload that same ZIP to the existing Chrome Web Store item. Do not create a new store item for normal updates.
6. Save the store item ID and public listing URL in the README after the first submission. Record the approved version and any reviewer feedback.
